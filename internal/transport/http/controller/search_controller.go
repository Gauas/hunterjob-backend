...
type SearchController struct{ service search.Service }

func NewSearchController(s search.Service) SearchController { return SearchController{service: s} }
func (h SearchController) AI(c *gin.Context) {
	var req struct {
