...
type AdminHandler struct{ sources source.Service }

func NewAdminHandler(s source.Service) AdminHandler { return AdminHandler{sources: s} }
...
func (h AdminHandler) CrawlOne(c *gin.Context) {
...
func (h AdminHandler) RestartCrawler(c *gin.Context) {
